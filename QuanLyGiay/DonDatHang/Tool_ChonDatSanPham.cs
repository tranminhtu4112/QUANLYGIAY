...
{
    public partial class Tool_ChonDatSanPham : Form
    {
        int mov, movX, movY;
        ...
        public Tool_ChonDatSanPham(String maHoaDon)
        {
            InitializeComponent();
            loadDataGiay();
            loadDataSapXepCombobox();
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            if (lvwGiay.SelectedItems.Count > 0)
            {
                ...
                Tool_NhapSoLuongDatHang toolNhapSoLuongDatHang = new Tool_NhapSoLuongDatHang(maGiay, soLuong, this.maHoaDon, phanTramGiamGia, gia);
        ...
        private void Tool_ChonDatSanPham_MouseDown(object sender, MouseEventArgs e)
        {
            mov = 1;
            movX = e.X;
            movY = e.Y;
        ...
        private void Tool_ChonDatSanPham_MouseMove(object sender, MouseEventArgs e)
        {
            if (mov == 1)
            {
        ...
        private void Tool_ChonDatSanPham_MouseUp(object sender, MouseEventArgs e)
        {
            mov = 0;
        }
    }
